...
| `cargo clippy` complains about `inconsistent_digit_grouping` | A literal like `2_100_000_000_00` mixes three- and two-digit groups | Regroup in consistent thousands. The $21B money ceiling is `2_100_000_000_000` cents (2.1 trillion cents = $21,000,000,000.00) — note the trailing group is `000`, not `00`. |
